            ...
            <div class="mx-auto grid max-w-[1170px] grid-cols-1 md:grid-cols-3 gap-10 px-6 pt-5">
                ...
                <div>
                    ...
                    <div class="flex gap-[10px] mt-6">
                        <!-- Facebook -->
                        <a href="#" class="w-[56px] h-[56px] bg-primary rounded-lg flex items-center justify-center hover:bg-red-700 transition-colors">
                    ...
                    <ul class="flex flex-col gap-[22px]">
                        ...
                        <li class="flex gap-[14px] items-start">
                            ...
                            <div>
                                ...
                                <p class="text-white/70 text-lg leading-7">5062 N 19th Ave Suite 103,<br>Phoenix, AZ 85015, USA.</p>
                            </div>
                        </li>
                        <!-- Phone -->
                        <li class="flex gap-[14px] items-start">
                            ...
                            <div>
                                ...
                                <a href="tel:7733196420" class="text-white/70 text-lg no-underline hover:text-primary transition-colors">773-319-6420</a>
                            </div>
                        </li>
                    </ul>
                </div>
