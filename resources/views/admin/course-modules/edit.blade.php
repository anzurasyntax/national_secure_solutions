...
@section('content')
    <form action="{{ route('admin.courses.modules.update', [$course, $module]) }}" method="POST" enctype="multipart/form-data" class="space-y-8 rounded-xl border border-gray-200 bg-white p-8 shadow-sm">
        ...
        <div class="flex justify-end gap-4">
            ...
            <button type="submit" class="rounded-lg bg-primary px-6 py-3 font-heading text-xs font-bold uppercase tracking-[0.15em] text-white shadow-md shadow-primary/25 hover:bg-red-700">Update module</button>
        </div>
    </form>
@endsection
