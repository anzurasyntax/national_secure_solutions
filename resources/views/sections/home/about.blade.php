<section class="mx-auto grid max-w-[92%] grid-cols-1 items-center gap-10 px-4 py-12 sm:max-w-[88%] sm:py-14 lg:max-w-[80%] lg:min-h-screen lg:grid-cols-2 lg:gap-12 lg:py-16">
    ...
    <div>
        <h2 class="font-heading text-3xl font-bold text-[#1c1c25] sm:text-4xl lg:text-[40px]">{{ $aboutPage->brand_title }}</h2>
        <span class="my-4 block h-[3px] w-20 bg-primary"></span>
        <div class="mb-8 text-base leading-8 text-gray-500 sm:text-lg sm:leading-9 lg:text-[17px] lg:leading-[40px] [&_p]:mb-3 [&_p:last-child]:mb-0">{!! $aboutPage->brand_intro !!}</div>
        <div class="space-y-6">
            <article class="flex gap-4 sm:gap-5">
                ...
                <div>
                    ...
                    <div class="text-base leading-8 text-gray-500 sm:text-lg sm:leading-9 lg:text-[17px] lg:leading-[35px] [&_p]:mb-3 [&_p:last-child]:mb-0">{!! $aboutPage->mission_body !!}</div>
                </div>
            </article>
            <article class="flex gap-4 sm:gap-5">
                <div class="shrink-0">
                ...
                <div>
                    ...
                    <div class="text-base leading-8 text-gray-500 sm:text-lg sm:leading-9 lg:text-[17px] lg:leading-[35px] [&_p]:mb-3 [&_p:last-child]:mb-0">{!! $aboutPage->vision_body !!}</div>
                </div>
            </article>
        </div>
    </div>
