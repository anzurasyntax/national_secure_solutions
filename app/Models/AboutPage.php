...
class AboutPage extends Model
{
    ...
    public static function defaultAttributes(): array
    {
        return [
            ...
            'brand_title' => 'TRANS-WORLD SECURITY',
            'brand_intro' => 'Trans-World Security Systems INC. is a seasoned security firm with 40 years of global experience, specializing in professional security guard services, top-notch security systems, and expert security consulting. Our founders are renowned authors of security-related publications, including "Effective Personal Corporate Security," "Kidnap: Face to Face with Death," and more.',
            'mission_title' => 'Our Mission',
            'mission_body' => 'Our mission at Trans-World Security Systems INC. is to deliver unparalleled security solutions that prioritize safety, trust, and peace of mind for our clients.',
            'vision_title' => 'Our Vision',
            'vision_body' => 'Securing your world so you can focus on the rest.',
            'memberships_heading' => 'Memberships',
            'memberships_body' => 'Trans-World Security Systems INC. is a proud member of the International Foundation for Protection Officers (IFPO) and the American Society for Industrial Security(ASIS), showcasing our commitment to upholding industry standards and best practices.',
            'leadership_heading' => 'Leadership',
            'leadership_body' => 'Ona Osezua Ekhomu, the President of Trans-World Security Systems INC., leads our team with a wealth of experience and a dedication to providing top-tier security services tailored to our clients\' specific needs.',
            'statement_heading' => 'TRANSWORLD Security is an international protection systems firm with operations in the U.S.A and Africa, We specialize in loss PREVENTION and ASSET PROTECTION for:',
